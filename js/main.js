		...
		switch (msg.$) {
			...
			case 'DinoList':
				...
				return ((model.name === '') || ((!model.age) || _Utils_eq(model.kind, $author$project$Model$NoKind))) ? _Utils_Tuple2(model, $elm$core$Platform$Cmd$none) : _Utils_Tuple2(
					_Utils_update(
						model,
						{
							dinoList: A2($elm$core$List$cons, newDino, model.dinoList)
						}),
					$elm$core$Platform$Cmd$none);
			case 'DinoSearchInput':
				var inputString = msg.a;
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{dinoSearch: inputString}),
					$elm$core$Platform$Cmd$none);
			case 'DinoFilter':
				var filterKind = msg.a;
				return _Utils_Tuple2(
					_Utils_update(
						model,
			...
			case 'ConfirmAlert':
				var newDinoList = A2(
					$elm$core$List$filter,
					function (dino) {
						return !_Utils_eq(dino.dinoID, model.dinoIDToDelete);
					},
					model.dinoList);
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{dinoList: newDinoList, showConfirm: false}),
					$elm$core$Platform$Cmd$none);
			case 'CancelAlert':
				return _Utils_Tuple2(
					_Utils_update(
			...
			case 'GotText':
				...
				if (result.$ === 'Ok') {
					...
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{fullTextFromInternet: stringFromInternet}),
						$elm$core$Platform$Cmd$none);
				} else {
					return _Utils_Tuple2(model, $elm$core$Platform$Cmd$none);
				}
...
var $author$project$Msg$DinoAge = function (a) {
	return {$: 'DinoAge', a: a};
};
var $author$project$Msg$DinoFilter = function (a) {
	return {$: 'DinoFilter', a: a};
};
var $author$project$Msg$DinoList = {$: 'DinoList'};
var $author$project$Msg$DinoName = function (a) {
	return {$: 'DinoName', a: a};
};
var $author$project$Msg$SaveDinoKind = function (a) {
	return {$: 'SaveDinoKind', a: a};
};
var $elm$html$Html$br = _VirtualDom_node('br');
var $author$project$Attributes$button = function (msg) {
	return _List_fromArray(
		[
...
var $author$project$Attributes$dino = _List_fromArray(
	[
		...
		A2($elm$html$Html$Attributes$style, 'color', '#993333')
	]);
...
var $author$project$Attributes$confirmAlert = function (msg) {
	return _Utils_ap(
		_List_fromArray(
			[
		...
		$author$project$Attributes$button(msg));
};
var $author$project$View$viewConfirmAlert = function (model) {
	var _v0 = model.showConfirm;
	if (_v0) {
		return A2(
			$elm$html$Html$div,
			$author$project$Attributes$confirmAlert($author$project$Msg$NoOp),
			_List_fromArray(
				[
					A2(
					$elm$html$Html$p,
					...
					_List_fromArray(
						[
							$elm$html$Html$Events$onClick($author$project$Msg$ConfirmAlert)
						]),
					_List_fromArray(
						[
					...
					_List_fromArray(
						[
							$elm$html$Html$Events$onClick($author$project$Msg$CancelAlert)
						]),
					_List_fromArray(
						[
			...
			[
				...
				A2(
					...
					function (dino) {
						...
						var dinoAgeString = $elm$core$String$fromInt(dino.age);
						return A2(
							$elm$html$Html$div,
							_List_Nil,
							_List_fromArray(
								[
									...
									_List_fromArray(
										[
											$elm$html$Html$text(
											dino.name + (' ' + (('Post ID: ' + $elm$core$String$fromInt(dino.dinoID)) + (' Dino Age: ' + (dinoAgeString + (' ' + (' Dino Kind: ' + (dinoKindString + '')))))))),
											A2($elm$html$Html$br, _List_Nil, _List_Nil),
											A2(
											$elm$html$Html$button,
											...
											$elm$html$Html$button,
											$author$project$Attributes$button(
												$author$project$Msg$DinoDelete(dino.dinoID)),
											_List_fromArray(
												[
					...
					$elm$core$List$reverse(
						A2(
							...
							A2(
								$elm$core$List$filter,
								function (dino) {
									return (!_Utils_eq(model.filterKind, $author$project$Model$NoKind)) ? _Utils_eq(model.filterKind, dino.kind) : ((model.dinoSearch === '') ? true : A2($elm$core$String$startsWith, model.dinoSearch, dino.name));
								},
								model.dinoList)))))
			]));
};
var $author$project$Msg$DinoSearchInput = function (a) {
	return {$: 'DinoSearchInput', a: a};
};
var $author$project$Attributes$searchBar = F2(
	function (customInputs, customPlaceHolders) {
		return _List_fromArray(
			[
				$elm$html$Html$Events$onInput(customInputs),
				$elm$html$Html$Attributes$placeholder(customPlaceHolders),
				A2($elm$html$Html$Attributes$style, 'background-color', '#d9fafc'),
				A2($elm$html$Html$Attributes$style, 'color', '364849'),
				A2($elm$html$Html$Attributes$style, 'font-size', '20px'),
				A2($elm$html$Html$Attributes$style, 'border', '0px'),
				A2($elm$html$Html$Attributes$style, 'padding', '10px'),
				A2($elm$html$Html$Attributes$style, 'margin', '5px'),
				A2($elm$html$Html$Attributes$style, 'width', '300px'),
				A2($elm$html$Html$Attributes$style, 'border', '2px'),
				A2($elm$html$Html$Attributes$style, 'border-radius', '20px')
			]);
	});
var $author$project$View$viewSearchBar = function (model) {
	return A2(
		$elm$html$Html$div,
		_List_Nil,
		_List_fromArray(
			[
				A2(
				$elm$html$Html$input,
				A2($author$project$Attributes$searchBar, $author$project$Msg$DinoSearchInput, 'Search For A Dino!'),
				_List_Nil)
			]));
};
...
var $author$project$View$viewValidation = F2(
	function (model, field) {
		var successMsg = A2(
			...
			_List_fromArray(
				[
					$elm$html$Html$text('Something to insert!')
				]));
		var errorMsg = A2(
			$elm$html$Html$div,
			_List_fromArray(
			...
			_List_fromArray(
				[
					$elm$html$Html$text('Nothing to read')
				]));
		switch (field) {
			case 'name':
				return (model.name === '') ? errorMsg : successMsg;
			case 'age':
				return (!model.age) ? errorMsg : successMsg;
			case 'kind':
				return A2(
					$elm$core$List$member,
					model.kind,
					_List_fromArray(
						[$author$project$Model$Big, $author$project$Model$Medium, $author$project$Model$Small])) ? successMsg : errorMsg;
			default:
				return A2($elm$html$Html$div, _List_Nil, _List_Nil);
		}
	});
var $author$project$View$view = function (model) {
	return A2(
		$elm$html$Html$div,
		$author$project$Attributes$dino,
		_List_fromArray(
			[
				A2(
				$elm$html$Html$h1,
				...
				_List_fromArray(
					[
						$elm$html$Html$text('Dino Catalog!')
					])),
				...
				A2(
				$elm$html$Html$button,
				$author$project$Attributes$button($author$project$Msg$DinoList),
				_List_fromArray(
					[
						$elm$html$Html$text('Send me a new Dino!')
					])),
				A2($elm$html$Html$br, _List_Nil, _List_Nil),
				A2($elm$html$Html$br, _List_Nil, _List_Nil),
				A2(
				$elm$html$Html$button,
				$author$project$Attributes$button(
					$author$project$Msg$DinoFilter($author$project$Model$Big)),
				_List_fromArray(
					[
						$elm$html$Html$text('Big Filter')
					])),
				A2(
				$elm$html$Html$button,
				$author$project$Attributes$button(
					$author$project$Msg$DinoFilter($author$project$Model$Medium)),
				_List_fromArray(
					[
						$elm$html$Html$text('Medium Filter')
					])),
				A2(
				$elm$html$Html$button,
				$author$project$Attributes$button(
					$author$project$Msg$DinoFilter($author$project$Model$Small)),
				_List_fromArray(
					[
						$elm$html$Html$text('Small Filter')
					])),
				A2(
				$elm$html$Html$button,
				$author$project$Attributes$button(
					$author$project$Msg$DinoFilter($author$project$Model$NoKind)),
				_List_fromArray(
					[
				...
				_List_fromArray(
					[
						$elm$html$Html$text(model.fullTextFromInternet)
					]))
			]));
};
